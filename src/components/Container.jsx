...
export function Container ({ className = '', header = {}, children }) {
  return (
    <>
      <div className="sticky top-0 z-50 border-b-slate-950 border-opacity-25 bg-white py-4 leading-none shadow-lg dark:border-b dark:bg-[#11191f] dark:bg-gradient-to-r dark:from-[#18232c]">
